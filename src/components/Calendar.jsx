...
import { setStartDate, setEndDate, changeMonth, changeYear } from "../features/calendar/calendarSlice";
...
const Calendar = () => {
    ...
    const handleClick = (d, isCurrentMonth) => {

        if (!isCurrentMonth) {
            dispatch(changeMonth(d.month() - current.month()));
            dispatch(changeYear(d.year() - current.year()));
    ...
    return (
        <div className="calendar">
            ...
            <div className="grid">
                ...
                ${isWeekend ? "weekend" : ""}
              `}
                            onClick={() => handleClick(d.date, d.current)}
                        >
                            {d.date.date()}
